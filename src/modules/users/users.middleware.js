...
export const protect = catchAsync(async (req, res, next) => {
  ...
  //5.no lo hice porque en el modelo no tengo el passwordChangedAt, tampoco pidio actualizar contraseña pero lo hicepara practicar un poquito las clases
...
export const restrictTo = (...roles) => {
  return (req, res, next) => {
    if (!roles.includes(req.sessionUser.role)) {
      return next(
        new AppError('You do not have permisiion to perfom this action',403)
      );
